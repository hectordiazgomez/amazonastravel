                ...
                children: [
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        //four social icons with open link facebook ,instagram , tiktok, youtube
                        IconButton(
                          icon: Icon(
                          ...
                          onPressed: () {
                            launchUrl(Uri.parse(
                                "https://facebook.com/dirceturamazonas1"));
                          },
                        ),
                        IconButton(
                          icon: Icon(
                          ...
                          onPressed: () {
                            launchUrl(Uri.parse(
                                "https://instagram.com/dircetur.amazonas"));
                          },
                        ),
                        IconButton(
                          icon: Icon(
                          ...
                          onPressed: () {
                            launchUrl(Uri.parse(
                                "https://youtube.com/@dirceturamazonas2567"));
                          },
                        ),
                        IconButton(
                          icon: Icon(
                          ...
                          onPressed: () {
                            launchUrl(Uri.parse(
                                "https://tiktok.com/@dirceturamazonas"));
                          },
                        ),
                      ],
                    ),
