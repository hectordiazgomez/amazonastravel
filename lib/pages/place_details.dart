...
import 'package:travel_hour/widgets/play_icon.dart';
...
class _PlaceDetailsState extends State<PlaceDetails> {
  ...
  handlePlayClick() {
    var videoSource = '';
    if (widget.data!.videoUrl!.contains('youtu')) {
      videoSource = 'youtube';
  ...
  Container _slidableImages() {
    ...
    if (widget.data!.imageUrl4 != null && widget.data!.imageUrl4!.isNotEmpty)
      images.add(CustomCacheImage(imageUrl: widget.data!.imageUrl4));
    if (widget.data!.imageUrl5 != null && widget.data!.imageUrl5!.isNotEmpty)
      images.add(CustomCacheImage(imageUrl: widget.data!.imageUrl5));
